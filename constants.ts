...
// NOTE: To use your own uploaded images:
// 1. Upload your images to a cloud provider (like Cloudinary, Imgur) or your project's 'public' folder.
// 2. Replace the 'src' URLs below with your specific image URLs.

export const GALLERY_IMAGES = [
  {
    id: 'g1',
    // Matches: Purple Scrub Set (Standing)
    src: 'https://images.pexels.com/photos/5215024/pexels-photo-5215024.jpeg?auto=compress&cs=tinysrgb&w=800',
    title: 'Signature Purple Scrub Set',
    category: 'Scrubs'
  },
  {
    id: 'g2',
    // Matches: White Tunic with Navy Piping (Duo)
    src: 'https://images.pexels.com/photos/5407206/pexels-photo-5407206.jpeg?auto=compress&cs=tinysrgb&w=800',
    title: 'Elegant White & Navy Tunics',
    category: 'Uniforms'
  },
  {
    id: 'g3',
    // Matches: White Lab Coat (Female)
  ...
  {
    id: 'g4',
    // Matches: Royal Blue Scrubs
    src: 'https://images.pexels.com/photos/5998474/pexels-photo-5998474.jpeg?auto=compress&cs=tinysrgb&w=800',
    title: 'Royal Blue Classics',
    category: 'Scrubs'
  },
  {
    id: 'g5',
    // Matches: Purple Tunic with African Print/Custom
    src: 'https://images.pexels.com/photos/5207094/pexels-photo-5207094.jpeg?auto=compress&cs=tinysrgb&w=800',
    title: 'Custom African Print Accents',
    category: 'Customization'
  },
  {
    id: 'g6',
    // Matches: Men's Black Scrubs (Sitting)
    src: 'https://images.pexels.com/photos/6325984/pexels-photo-6325984.jpeg?auto=compress&cs=tinysrgb&w=800',
    title: 'Men\'s Black Tactical Set',
    category: 'Scrubs'
  },
  {
    id: 'g7',
    // Matches: Surgical Cap
    src: 'https://images.pexels.com/photos/3902882/pexels-photo-3902882.jpeg?auto=compress&cs=tinysrgb&w=800',
    title: 'Heartbeat Surgical Caps',
    category: 'Accessories'
  },
  {
    id: 'g8',
    // Matches: White Tunic (Sitting)
    src: 'https://images.pexels.com/photos/5327653/pexels-photo-5327653.jpeg?auto=compress&cs=tinysrgb&w=800',
    title: 'Tailored Fit Uniforms',
    category: 'Uniforms'
  },
  {
    id: 'g9',
    // Matches: Grey/White Coat combo
    src: 'https://images.pexels.com/photos/4173251/pexels-photo-4173251.jpeg?auto=compress&cs=tinysrgb&w=800',
    title: 'Modern Clinical Attire',
    category: 'Lab Coats'
  },
  {
    id: 'g10',
    // Matches: Blue Scrubs (Alternate)
    src: 'https://images.pexels.com/photos/4033148/pexels-photo-4033148.jpeg?auto=compress&cs=tinysrgb&w=800',
    title: 'Premium Scrub Collection',
    category: 'Scrubs'
  }
];
